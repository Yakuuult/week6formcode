...
app.get('/getPOI', function (req,res) {pool.connect(function(err,client,done)
 {
 if(err){
...
var querystring = "INSERT into formdata (clientid,surname,module,language, modulelist, correctanswer, geom) values ('"; querystring = querystring + req.body.clientid + "','" + req.body.surname + "','" + req.body.module + "','"; querystring = querystring + req.body.language + "','" + req.body.modulelist + "','" + req.body.correctanswer+"',"+geometrystring + "))";
console.log(querystring);
client.query( querystring,function(err,result) {
done();
if(err){
